 ...
 * $Id$
 */
class CRM_Addresslog_Form_Report_AddressLog extends CRM_Logging_ReportSummary {
  /**
   * Class constructor.
   */
    ...
    $this->_columns = array(
      'log_civicrm_entity' => array(
        ...
        'fields' => array(
          ...
          'altered_street_address' => array(
            'name' => 'street_address',
            'alias' => 'modified_contact_address',
...
INNER JOIN civicrm_contact modified_contact_civireport
 ...
 LEFT JOIN civicrm_address modified_contact_address
        ON (entity_log_civireport.{$detail['fk']} = modified_contact_address.contact_id {$clause})";
